...
<div class="container-fluid bg-light pt-5 pb-4">
   <div class="container py-5">
      <div class="d-flex flex-column text-center mb-5">
         <h4 class="text-secondary mb-3"><?= $obj->dataProvider->getVariables(Variable::PRICING_PLAN_HEAD1) ?></h4>
         <h1 class="display-4 m-0"><?= $obj->dataProvider->getVariables(Variable::PRICING_PLAN_HEAD2) ?></h1>
      </div>
      <div class="row">
