...
<div class="mb-5">
    ...
    <?php foreach ($obj->dataProvider->getActiveArticles() as $article) :
        ...
        <div class="d-flex align-items-center border-bottom mb-3 pb-3">
            ...
            <div class="d-flex flex-column pl-3">
                <a class="text-dark mb-2" href="<?= $obj->dataProvider->getVariables(Variable::URL_ARTICLE_VIEW) . $article->id; ?>"> <?= "<b>" . $title . "</b>" .  " " . $description . "..."; ?></a>
                <div class="d-flex">
    ...
    <?php endforeach; ?>
    <div class="d-flex align-items-center border-bottom mb-3 pb-3">
        <a class=" font-weight-bold mb-2" href="<?= $obj->dataProvider->getVariables(Variable::URL_ARTICLES_VIEW); ?>"> Читать все статьи</a>
    </div>
